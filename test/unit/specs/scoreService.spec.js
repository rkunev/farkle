...
describe('scoreService', () => {
    describe('getPrimitives:', () => {
        ...
        it('should get 100 points with 2 fives', () => {
        ...
        it('should get 100 points with 1 repeated once', () => {
        ...
        it('should get 200 points with 2 ones', () => {
        ...
        it('should get 150 points with `1` & `5`', () => {
        ...
        it('should get 250 points with 2 ones and 1 five', () => {
    ...
    describe('getThreePairs:', () => {
        it('should get 1500 points from unique pairs', () => {
        ...
        it('should get 1500 points from non-unique pairs', () => {
    ...
    describe('getRepeatedPrimitives:', () => {
        ...
        it('should get 0 points with all unique', () => {
            const dice = [1, 2, 3, 4, 5, 6];
            const result = scoreService.getRepeatedPrimitives(dice);
        ...
        it('should get 0 points with 2 repeated values', () => {
            const dice = [1, 1, 3, 4, 5, 6];
            const result = scoreService.getRepeatedPrimitives(dice);
...
// Test cases: getters call scoreService to calculate score
// rolledScore = scoreService.calculate([2, 2, 3, 4, 6, 6]); // 500
