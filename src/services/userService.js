...
export default {
    ...
    removeAnonymousUser: removeAnonymousUser,
    hasAnonymousUser: hasAnonymousUser,

    useAnonymousAccount: useAnonymousAccount,
    isUsingAnonymousAccount: isUsingAnonymousAccount,
}
...
function hasAnonymousUser() {
    return !!getAnonymousUser();
}

function removeAnonymousUser() {
    localStorage.removeItem(STORAGE_KEY_USER);
}

function useAnonymousAccount(isAnonymous = true) {
 ...
 */
function isUsingAnonymousAccount() {
